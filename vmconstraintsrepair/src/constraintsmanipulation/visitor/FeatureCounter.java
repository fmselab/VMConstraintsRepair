 ...
 */
public class FeatureCounter implements ExpressionVisitor<Integer> {

	Collection<IdExpression> features;
	...
	public Integer forIdExpression(IdExpression idExpression) {
		if (features.contains(idExpression)) return 0;
		features.add(idExpression);
		return 1;
	}
	...
	public Integer forXOrExpression(XOrExpression xOrExpression) {
		return xOrExpression.getFirstOperand().accept(this) + xOrExpression.getSecondOperand().accept(this);
	}
